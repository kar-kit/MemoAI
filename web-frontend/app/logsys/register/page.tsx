    ...
    <div className="relative flex justify-center items-center px-6 min-h-screen overflow-hidden">
      ...
      >
        ...
        <form className="space-y-5 mt-8" onSubmit={onSubmit}>
          ...
          <button className="bg-gradient-to-r from-indigo-600 hover:from-indigo-600 to-indigo-500 hover:to-indigo-400 shadow-[0_8px_20px_rgba(79,70,229,0.25)] py-2.5 rounded-full w-full font-medium text-white text-sm transition-all duration-300">
            Create account
          </button>
        </form>
